...
public class Constants {
    ...
    public static final String MERCHANT_KEY = "Bl3ImHo8";
    public static final String MERCHANT_SALT = "KMnA2T1gAO";
    public static final String MERCHANT_ID = "4934580";
    public static final boolean DEBUG = true;

    public static final String FIRST_NAME = "MHFortune";
    public static final String MOBILE = "7204342561";
    public static final String EMAIL = "mhfortuneadvertising@icloud.com";
}
